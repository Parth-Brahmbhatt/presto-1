        ...
        extends ConnectorExpression
{
    ...
    public ComparisonExpression(Operator operator, ConnectorExpression left, ConnectorExpression right)
    {
    ...
    {
        return new StringJoiner(", ", ComparisonExpression.class.getSimpleName() + "[", "]")
